    ...
    const features = {
      ...
      proxy: () => {
        if (this.options.proxy) {
          ...
          if (!Array.isArray(this.options.proxy)) {
            if (
              Object.prototype.hasOwnProperty.call(this.options.proxy, 'target')
            ) {
              this.options.proxy = [this.options.proxy];
            } else {
              this.options.proxy = Object.keys(this.options.proxy).map(
                (context) => {
                  let proxyOptions;
      ...
      contentBaseFiles: () => {
        if (Array.isArray(contentBase)) {
          ...
          app.get('*', express.static(contentBase, this.options.staticOptions));
        }
      },
      contentBaseIndex: () => {
        if (Array.isArray(contentBase)) {
      ...
      before: () => {
        if (typeof this.options.before === 'function') {
          this.options.before(app, this, this.compiler);
        }
      },
      middleware: () => {
      ...
      after: () => {
        if (typeof this.options.after === 'function') {
          this.options.after(app, this, this.compiler);
        }
      },
      headers: () => {
